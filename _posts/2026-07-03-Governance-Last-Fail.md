...
I spent years inside large, regulated organizations where every gate, board, and sign off had a name and a reason. What I want to argue here is not that governance is bad. Governance done well is one of the most valuable things a leader can build. What I want to argue is that governance has a natural tendency to only grow, and that tendency will quietly strangle an organization's ability to move unless someone takes responsibility for pruning it. That pruning is not an IT function or a PMO function. It is a leadership function, and most leaders never claim it.
