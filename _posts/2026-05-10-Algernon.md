...
tags:
  ...
  - AI Adoption
---
*Flowers for Algernon* is a 1966 novel by Daniel Keyes in which Charlie Gordon, a man with an intellectual disability, undergoes 
experimental surgery that dramatically raises his intelligence, only to watch that intelligence fade as the experiment fails 
and he returns to who he was before. The cruelty of the story is not the regression itself. 
It is that Charlie, unlike Algernon the mouse, is aware of what he is losing as it leaves him.
...
I was building toward a proof of concept. Local open-weight models served through Ollama doing the bounded, low-stakes tasks. Smaller context windows, faster inference, no data leaving the network perimeter. It was a reasonable architecture for regulated work, and the cost profile made experimentation tractable at the team level.

Then, without an email, without a conversation, without a meeting, Ollama was uninstalled from my machine. I found out when it stopped responding.

## What Organizational Immune Systems Actually Protect

I want to be precise here, because I have seen this pattern enough times to know what is actually happening.

The decision to remove local development tooling was not made by someone who evaluated the threat model of Ollama and concluded it was too risky. That kind of analysis would produce a written rationale, a policy, an alternative path. It would produce a conversation. What I got instead was a silent uninstall, which is the signature of an organizational immune system doing what immune systems do: neutralizing foreign material before anyone has to think carefully about it.

The accompanying position, that local development is not viable at all, deserves real scrutiny. Local development of what, for whom, at what risk level? The blanket claim is not a security posture. It is a sentence that ends the conversation without starting it. That is its function.

Organizations that have made real security decisions can explain them. They can tell you what threat they are mitigating, what data they are protecting, and what the boundaries of the policy are. They can point to a risk register entry. What they cannot do is give you the silent uninstall followed by a vague assertion that local development is categorically unworkable. That is institutional defensiveness, not risk management.
...
The regression Charlie experienced was chemical and involuntary. The regression I am experiencing is organizational and deliberate. But the epistemic gap is structurally identical. The person who has seen the other side of the capability curve cannot unknow it. The people making the tooling decisions have not seen it. That asymmetry of understanding is the actual problem, and the uninstall is just its most visible symptom.
...
Charlie Gordon's tragedy was that he could not control the biology. I can control the strategy. The regression is real, but it is not permanent. The ceiling exists, and I know where it is, and knowing is most of the work.

The rest is just time, evidence, and the right conversation with the right person.
